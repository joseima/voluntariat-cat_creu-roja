...
export function CreateActivity() {
  return (
    <Link
      ...
      className="flex h-10 items-center rounded-lg bg-red-700 px-4 text-sm font-medium text-white transition-colors hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
    >
...
export function UpdateActivity({ id }: { id: string }) {
  return (
    <Link
